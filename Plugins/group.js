    ...
    switch (inputCMD) {
        ...
        try{
           await Atlas.groupUpdateSubject(m.from, text);
             Atlas.sendMessage(
              ...
              await doReact("❌");
             m.reply(`An error occurred while updating the group name.`);
             console.error(err)
        }
        break;
      ...
      case "grouplink":
        ...
        try {
         ...
         let link
          try{
             link = await Atlas.groupInviteCode(m.from);
          }catch(error){
              await doReact("❌");
                m.reply(`An error occurred while fetching group link`);
                 console.error(error)
              return;
          }
        ...
        try {
          await Atlas.sendMessage(
            ...
            { quoted: m }
             ...
             await doReact("❌");
             m.reply(`An error occurred while sending group link.`);
             console.error(err)
        }
        break;
        ...
        try{
          if (text === "close") {
             ...
             await Atlas.sendMessage(
              ...
              await doReact("❌");
               m.reply(`An error occurred while changing group settings.`);
                console.error(error)
        }
        break;
               ...
               await Atlas.sendMessage(m.from, {
                ...
                quoted: m,
                 ...
                 await  Atlas.groupLeave(m.from)
                   ...
                   await doReact("❌");
                   m.reply(`An error Occurd while leaving !`);
                  console.error(error)
             }
        break;
         ...
         try{
             ...
             Atlas.sendMessage(
              ...
              Atlas.sendMessage(
                m.from,
                {
                  text: `An error occured while trying to promote @${
                    mentionedUser.split("@")[0]
                  } Senpai !\n\n*Error:* ${error}`,
                  mentions: [mentionedUser],
                },
      ...
      case "remove":
        ...
        if (groupAdmin.includes(users)) {
         ...
         try{
             ...
             await doReact("❌");
               m.reply(
               `An error Occurd while removing user from this group`
                );
             console.error(error)
         }
      ...
      case "setppgc":
        ...
        let quotedimage = await Atlas.downloadAndSaveMediaMessage(quoted);
         let  preview
        try{
             const {  preview: p } = await generatePP(quotedimage);
            preview = p;
             await Atlas.query({
               tag: "iq",
               attrs: {
               ...
               await doReact("❌");
               m.reply(
               `An error Occurd while changing group profile picture`
                );
              console.error(error)
      ...
      case "setgcdesc":
        ...
        try{
           await Atlas.groupUpdateDescription(m.from, newGCdesc)
            ...
            await doReact("❌");
              m.reply(
                  `An error occurred while updating the group description.`
             );
             console.error(error)
        }
      ...
      case "revoke":
        ...
        try{
           await Atlas.groupRevokeInvite(m.from)
            ...
            await doReact("❌");
             m.reply(
               `An error Occurd while updating the group link`
              );
             console.error(error)
        }
        break;
      ...
      case "chatbotgc":
        ...
        chatbotGCStatus = await checkGroupChatbot(m.from);
           try{
                ...
                await doReact("❌");
                   m.reply(
                      `An error Occurd while changing chatbot settings.`
                    );
                   console.error(error)
              }
      ...
      case "antilink":
        ...
        try{
          if (args[0] == "on") {
           ...
           await doReact("❌");
            m.reply(
               `An error Occurd while changing antilink settings.`
             );
            console.error(error)
        }
